/** アプリのルーティング設定
 */
export default class QuizAppConfigRoute {
  ...
  static activate($routeProvider) {
    QuizAppConfigRoute.instance = new QuizAppConfigRoute($routeProvider);
    return QuizAppConfigRoute.instance;
  }
}

QuizAppConfigRoute.$inject = ["$routeProvider"];
